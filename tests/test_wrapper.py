...
class TestLarchWrapper:
    ...
    def test_print_diagnostics(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            assert any(keyword in diagnostic_text.lower() for keyword in ['larch', 'wrapper', 'diagnostics', 'system'])
    ...
    def test_generate_feff_input_delegation(self, mock_generate):
        ...
        # The wrapper doesn't have a generate_feff_input method - it delegates to feff_utils
    ...
    def test_run_feff(self):
        ...
        with patch('larch_cli_wrapper.wrapper.run_feff_calculation', return_value=True) as mock_run:
            wrapper = LarchWrapper()
    ...
    def test_plot_results_basic(self):
        ...
        try:
            ...
            # If plotting fails due to matplotlib complexity, at least verify the method exists
